...
<Button size="sm" label="delete" btnType="outlined" isAnimated={false} onButtonClick={() => {}} />
<Button size="md" label="delete" btnType="outlined" isAnimated={false} onButtonClick={() => {}} />
<Button size="lg" label="delete" btnType="outlined" isAnimated={false} onButtonClick={() => {}} />
<Button size="xl" label="delete" btnType="outlined" isAnimated={false} onButtonClick={() => {}} />
<Button size="xxl" label="delete" btnType="outlined" isAnimated={false} onButtonClick={() => {}} />
<!-- <Button size="md" label="save" btnType="secondary" isAnimated={false} onButtonClick={() => {}} />
<Button size="md" label="save" btnType="outlined" isAnimated={false} onButtonClick={() => {}} />
<Button size="xs" label="save" btnType="textOnly" isAnimated={false} onButtonClick={() => {}} /> -->
